...
export const escalones: ServicioEscalon[] = [
  ...
  },
  {
    ...
    queHacemos:
      "Construimos y desplegamos la automatización de un único proceso, integrada con las herramientas que ya usas. Sin cambiar tu stack, sin licencias que no necesitas.",
    queRecibes: [
    ...
    condiciones: [
      "Precio cerrado a partir de los datos del diagnóstico. La vara de medir es el ahorro anual del proceso, no nuestras horas.",
    ],
  },
  {
    code: "03",
    ...
    queHacemos:
      "Convertimos el uso clandestino en un carril oficial. Ni prohibición imposible de vigilar, ni barra libre.",
    queRecibes: [
    ...
    nota: "El riesgo no se elimina, se reduce y se hace demostrable. Igual que en ciberseguridad. Quien te prometa lo contrario te está vendiendo humo.",
  },
  {
    code: "04",
    slug: "mantenimiento_",
    ...
    paraQuien:
      "Empresas con módulos en producción o con el programa de uso seguro implantado.",
    queHacemos:
...
export const formacion = {
  ...
  queHacemos:
    "Sesión práctica con los casos reales de tu empresa, no un curso genérico de diapositivas. Tu equipo sale sabiendo qué puede hacer con IA, qué no, y por qué. Tú te llevas el registro de formación como evidencia.",
  porQueEmpezar:
